...
class PayoutPrincipal(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, principal, principal_id, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, principal, principal_id, *args, **kwargs):  # noqa: E501
        """PayoutPrincipal - a model defined in OpenAPI
