...
class RejectedPaymentV3(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, remote_id, currency_type, amount, source_account_name, payor_payment_id, reason, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, remote_id, currency_type, amount, source_account_name, payor_payment_id, reason, *args, **kwargs):  # noqa: E501
        """RejectedPaymentV3 - a model defined in OpenAPI
