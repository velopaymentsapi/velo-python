...
class SourceEvent(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, source_type, event_id, created_at, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, source_type, event_id, created_at, *args, **kwargs):  # noqa: E501
        """SourceEvent - a model defined in OpenAPI
