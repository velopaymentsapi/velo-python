...
class PayoutPayor(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, payor_id, payor_name, dba_name, principal, principal_id, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, payor_id, payor_name, dba_name, principal, principal_id, *args, **kwargs):  # noqa: E501
        """PayoutPayor - a model defined in OpenAPI
