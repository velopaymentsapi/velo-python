...
class InviteUserRequest(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'roles': ([str],),  # noqa: E501
            'secondary_contact_number': (str, none_type,),  # noqa: E501
            'first_name': (str,),  # noqa: E501
            'last_name': (str,),  # noqa: E501
            'entity_id': (str, none_type,),  # noqa: E501
            'user_type': (str,),  # noqa: E501
            'verification_code': (str, none_type,),  # noqa: E501
        }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, email, mfa_type, sms_number, primary_contact_number, roles, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            secondary_contact_number (str, none_type): The secondary contact number for the user . [optional]  # noqa: E501
            first_name (str): [optional]  # noqa: E501
            last_name (str): [optional]  # noqa: E501
            entity_id (str, none_type): The payorId or payeeId or null if the user is a backoffice admin . [optional]  # noqa: E501
            user_type (str): Will default to PAYOR if not provided but entityId is provided. [optional]  # noqa: E501
            verification_code (str, none_type): Optional property that MUST be suppied when manually verifying a user The user's smsNumber is registered via a separate endpoint and an OTP sent to them . [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, email, mfa_type, sms_number, primary_contact_number, roles, *args, **kwargs):  # noqa: E501
        """InviteUserRequest - a model defined in OpenAPI
