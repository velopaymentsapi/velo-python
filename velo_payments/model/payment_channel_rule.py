...
class PaymentChannelRule(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, element, required, display_name, validation, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            min_length (int): mininum length of the element data. [optional]  # noqa: E501
            max_length (int): maximum length of the element data. [optional]  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, element, required, display_name, validation, *args, **kwargs):  # noqa: E501
        """PaymentChannelRule - a model defined in OpenAPI
