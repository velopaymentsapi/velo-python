...
class CreateWebhookRequest(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, payor_id, webhook_url, enabled, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            authorization_header (str): the authorization header to include with the notification.. [optional]  # noqa: E501
            categories ([Category]): the categories to enable.. [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, payor_id, webhook_url, enabled, *args, **kwargs):  # noqa: E501
        """CreateWebhookRequest - a model defined in OpenAPI
