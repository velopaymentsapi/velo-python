...
class Notification(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, api_version, sequence_number, category, event_name, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            source (bool, date, datetime, dict, float, int, list, str, none_type): One of the available set of source event payloads. [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, api_version, sequence_number, category, event_name, *args, **kwargs):  # noqa: E501
        """Notification - a model defined in OpenAPI
