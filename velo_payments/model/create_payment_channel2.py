...
class CreatePaymentChannel2(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, country_code, currency, account_name, *args, **kwargs):  # noqa: E501
        """CreatePaymentChannel2 - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            iban (str): Must match the regular expression ```^[A-Za-z0-9]+$```. Either routing number and account number or only iban must be set. [optional]  # noqa: E501
            account_number (str): Either routing number and account number or only iban must be set. [optional]  # noqa: E501
            routing_number (str): Either routing number and account number or only iban must be set. [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, country_code, currency, account_name, *args, **kwargs):  # noqa: E501
        """CreatePaymentChannel2 - a model defined in OpenAPI
