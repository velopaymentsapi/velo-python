...
def lazy_import():
    ...
    globals()['OnboardedStatusV32'] = OnboardedStatusV32


class PayeeDeltaV3(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'onboarded_status': (OnboardedStatusV32,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, remote_id, payee_id, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            onboarded_status (OnboardedStatusV32): [optional]  # noqa: E501
        """
