...
class LocalisationDetails(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            template (str): the English language message template used to construct the error message. [optional]  # noqa: E501
            parameters ({str: (str,)}): name to value map containing any named parameters that appear in the message template. [optional]  # noqa: E501
        """
