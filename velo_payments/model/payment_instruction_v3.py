...
def lazy_import():
    ...
    globals()['TransmissionType'] = TransmissionType


class PaymentInstructionV3(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, remote_id, currency, amount, source_account_name, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            payment_memo (str): <p>Any value here will override the memo value in the parent payout</p> <p>This should be the reference field on the statement seen by the payee (but not via ACH)</p> . [optional]  # noqa: E501
            payor_payment_id (str): A reference identifier for the payor for the given payee payment. [optional]  # noqa: E501
            transmission_type (TransmissionType): [optional]  # noqa: E501
            remote_system_id (str): <p>The identifier for the remote payments system if not Velo</p> <p>Should only be used after consultation with Velo Payments</p> . [optional]  # noqa: E501
            payment_metadata (str): <p>Metadata about the payment that may be relevant to the specific rails or remote system making the payout</p> <p>The structure of the data will be dictated by the requirements of the payment rails</p> . [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, remote_id, currency, amount, source_account_name, *args, **kwargs):  # noqa: E501
        """PaymentInstructionV3 - a model defined in OpenAPI
