...
class PayeeInvitationApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.create_payee_v3_endpoint = _Endpoint(
            settings={
                'response_type': (CreatePayeesCSVResponseV3,),
                'auth': [
                    'OAuth2'
                ],
                'endpoint_path': '/v3/payees',
                'operation_id': 'create_payee_v3',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
                'all': [
                    'create_payees_request_v3',
                ],
                'required': [],
                'nullable': [
                ],
        ...
        self.get_payees_invitation_status_v3_endpoint = _Endpoint(
            settings={
                'response_type': (PagedPayeeInvitationStatusResponseV3,),
                'auth': [
                    'OAuth2'
                ],
        ...
        self.get_payees_invitation_status_v4_endpoint = _Endpoint(
            settings={
                'response_type': (PagedPayeeInvitationStatusResponseV4,),
                'auth': [
                    'OAuth2'
                ],
        ...
        self.query_batch_status_v3_endpoint = _Endpoint(
            settings={
                'response_type': (QueryBatchResponseV3,),
                'auth': [
                    'OAuth2'
                ],
        ...
        self.query_batch_status_v4_endpoint = _Endpoint(
            settings={
                'response_type': (QueryBatchResponseV4,),
                'auth': [
                    'OAuth2'
                ],
        ...
        self.v4_create_payee_endpoint = _Endpoint(
            settings={
                'response_type': (CreatePayeesCSVResponseV4,),
                'auth': [
                    'OAuth2'
                ],
    ...
    def create_payee_v3(
        ...
        **kwargs
        ...
        Keyword Args:
            create_payees_request_v3 (CreatePayeesRequestV3): Post payees to create.. [optional]
        ...
        return self.create_payee_v3_endpoint.call_with_http_info(**kwargs)
    ...
    def resend_payee_invite_v3(
        ...
        **kwargs
        ...
        Args:
            ...
            invite_payee_request_v3 (InvitePayeeRequestV3): Provide Payor Id in body of request
        ...
        kwargs['payee_id'] = \
            payee_id
        kwargs['invite_payee_request_v3'] = \
            invite_payee_request_v3
    ...
    def resend_payee_invite_v4(
        ...
        **kwargs
        ...
        Args:
            payee_id (str): The UUID of the payee.
            invite_payee_request_v4 (InvitePayeeRequestV4): Provide Payor Id in body of request
        ...
        kwargs['payee_id'] = \
            payee_id
        kwargs['invite_payee_request_v4'] = \
            invite_payee_request_v4
    ...
    def v4_create_payee(
        ...
        **kwargs
        ...
        Keyword Args:
            create_payees_request_v4 (CreatePayeesRequestV4): Post payees to create.. [optional]
            _return_http_data_only (bool): response data without head status
                code and headers. Default is True.
            _preload_content (bool): if False, the urllib3.HTTPResponse object
                will be returned without reading/decoding response data.
