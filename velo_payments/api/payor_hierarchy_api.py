...
class PayorHierarchyApi(object):
    ...
    def payor_links_v1(self, **kwargs):  # noqa: E501
        ...
        return self.payor_links_v1_with_http_info(**kwargs)  # noqa: E501

    def payor_links_v1_with_http_info(self, **kwargs):  # noqa: E501
        """List Payor Links  # noqa: E501

        <p>If the payor is set up as part of a hierarchy you can use this API to traverse the hierarchy</p>   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.payor_links_v1_with_http_info(async_req=True)
        >>> result = thread.get()
