...
class PaymentAuditServiceApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.export_transactions_csvv4_endpoint = _Endpoint(
            settings={
                'response_type': (PayorAmlTransaction,),
                'auth': [
                    'OAuth2'
                ],
                'endpoint_path': '/v4/paymentaudit/transactions',
                'operation_id': 'export_transactions_csvv4',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.get_fundings_v4_endpoint = _Endpoint(
            settings={
                'response_type': (GetFundingsResponse,),
                'auth': [
                    'OAuth2'
                ],
                'endpoint_path': '/v4/paymentaudit/fundings',
                'operation_id': 'get_fundings_v4',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.get_payment_details_v4_endpoint = _Endpoint(
            settings={
                'response_type': (PaymentResponseV4,),
                'auth': [
                    'OAuth2'
                ],
                'endpoint_path': '/v4/paymentaudit/payments/{paymentId}',
                'operation_id': 'get_payment_details_v4',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.get_payments_for_payout_v4_endpoint = _Endpoint(
            settings={
                'response_type': (GetPaymentsForPayoutResponseV4,),
                'auth': [
                    'OAuth2'
                ],
                'endpoint_path': '/v4/paymentaudit/payouts/{payoutId}',
                'operation_id': 'get_payments_for_payout_v4',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.get_payout_stats_v4_endpoint = _Endpoint(
            settings={
                'response_type': (GetPayoutStatistics,),
                'auth': [
                    'OAuth2'
                ],
                'endpoint_path': '/v4/paymentaudit/payoutStatistics',
                'operation_id': 'get_payout_stats_v4',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.get_payouts_for_payor_v4_endpoint = _Endpoint(
            settings={
                'response_type': (GetPayoutsResponse,),
                'auth': [
                    'OAuth2'
                ],
                'endpoint_path': '/v4/paymentaudit/payouts',
                'operation_id': 'get_payouts_for_payor_v4',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
            ...
            root_map={
                ...
                'attribute_map': {
                    ...
                    'submitted_date_from': 'submittedDateFrom',
                    'submitted_date_to': 'submittedDateTo',
                    'from_payor_name': 'fromPayorName',
                    'scheduled_for_date_from': 'scheduledForDateFrom',
                    'scheduled_for_date_to': 'scheduledForDateTo',
                ...
                'location_map': {
                    ...
                    'submitted_date_from': 'query',
                    'submitted_date_to': 'query',
                    'from_payor_name': 'query',
                    'scheduled_for_date_from': 'query',
                    'scheduled_for_date_to': 'query',
                    'schedule_status': 'query',
                    'page': 'query',
                    'page_size': 'query',
                    'sort': 'query',
                },
        ...
        self.list_payment_changes_v4_endpoint = _Endpoint(
            settings={
                'response_type': (PaymentDeltaResponse,),
                'auth': [
                    'OAuth2'
                ],
                'endpoint_path': '/v4/payments/deltas',
                'operation_id': 'list_payment_changes_v4',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.list_payments_audit_v4_endpoint = _Endpoint(
            settings={
                'response_type': (ListPaymentsResponseV4,),
                'auth': [
                    'OAuth2'
                ],
                'endpoint_path': '/v4/paymentaudit/payments',
                'operation_id': 'list_payments_audit_v4',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def export_transactions_csvv4(
        ...
        **kwargs
        ...
        return self.export_transactions_csvv4_endpoint.call_with_http_info(**kwargs)
    ...
    def get_fundings_v4(
        ...
        **kwargs
        ...
        kwargs['payor_id'] = \
            payor_id
        return self.get_fundings_v4_endpoint.call_with_http_info(**kwargs)

    def get_payment_details_v4(
        self,
        payment_id,
        **kwargs
    ):
        ...
        kwargs['payment_id'] = \
            payment_id
        return self.get_payment_details_v4_endpoint.call_with_http_info(**kwargs)

    def get_payments_for_payout_v4(
        self,
        payout_id,
        **kwargs
    ):
        ...
        kwargs['payout_id'] = \
            payout_id
        return self.get_payments_for_payout_v4_endpoint.call_with_http_info(**kwargs)

    def get_payout_stats_v4(
        self,
        **kwargs
    ):
        ...
        kwargs['_content_type'] = kwargs.get(
            '_content_type')
        kwargs['_host_index'] = kwargs.get('_host_index')
        return self.get_payout_stats_v4_endpoint.call_with_http_info(**kwargs)

    def get_payouts_for_payor_v4(
        self,
        **kwargs
    ):
        ...
        kwargs['_content_type'] = kwargs.get(
            '_content_type')
        kwargs['_host_index'] = kwargs.get('_host_index')
        return self.get_payouts_for_payor_v4_endpoint.call_with_http_info(**kwargs)

    def list_payment_changes_v4(
        self,
        payor_id,
        updated_since,
        **kwargs
        ...
        kwargs['updated_since'] = \
            updated_since
        return self.list_payment_changes_v4_endpoint.call_with_http_info(**kwargs)

    def list_payments_audit_v4(
        self,
        **kwargs
    ):
        ...
        kwargs['_content_type'] = kwargs.get(
            '_content_type')
        kwargs['_host_index'] = kwargs.get('_host_index')
        return self.list_payments_audit_v4_endpoint.call_with_http_info(**kwargs)
