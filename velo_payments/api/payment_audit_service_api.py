...
class PaymentAuditServiceApi(object):
    ...
    def get_payments_for_payout_v4_with_http_info(self, payout_id, **kwargs):  # noqa: E501
        ...
        all_params = ['payout_id', 'remote_id', 'remote_system_id', 'status', 'source_amount_from', 'source_amount_to', 'payment_amount_from', 'payment_amount_to', 'submitted_date_from', 'submitted_date_to', 'transmission_type', 'page', 'page_size', 'sort', 'sensitive']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def get_payouts_for_payor_v4_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['payor_id', 'payout_memo', 'status', 'submitted_date_from', 'submitted_date_to', 'from_payor_name', 'page', 'page_size', 'sort']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
