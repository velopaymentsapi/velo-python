...
class PaymentAuditServiceApi(object):
    ...
    def export_transactions_csv(self, **kwargs):  # noqa: E501
        ...
        >>> thread = api.export_transactions_csv(async_req=True)
        >>> result = thread.get()
        ...
        return self.export_transactions_csv_with_http_info(**kwargs)  # noqa: E501

    def export_transactions_csv_with_http_info(self, **kwargs):  # noqa: E501
        """Export Transactions  # noqa: E501

        Download a CSV file containing payments in a date range. Uses Transfer-Encoding - chunked to stream to the client. Date range is inclusive of both the start and end dates.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.export_transactions_csv_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['payor_id', 'start_date', 'submitted_date_from', 'include']  # noqa: E501
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    ...
                    " to method export_transactions_csv" % key
                )
    ...
    def get_fundings(self, **kwargs):  # noqa: E501
        """Get Fundings for Payor  # noqa: E501

        Get a list of Fundings for a payor.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_fundings(async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.get_fundings_with_http_info(**kwargs)  # noqa: E501

    def get_fundings_with_http_info(self, **kwargs):  # noqa: E501
        """Get Fundings for Payor  # noqa: E501

        Get a list of Fundings for a payor.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_fundings_with_http_info(async_req=True)
        >>> result = thread.get()
    ...
    def get_payouts_for_payor(self, payor_id, **kwargs):  # noqa: E501
        """Get Payouts for Payor  # noqa: E501

        Get List of payouts for payor   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_payouts_for_payor(payor_id, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.get_payouts_for_payor_with_http_info(payor_id, **kwargs)  # noqa: E501

    def get_payouts_for_payor_with_http_info(self, payor_id, **kwargs):  # noqa: E501
        """Get Payouts for Payor  # noqa: E501

        Get List of payouts for payor   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_payouts_for_payor_with_http_info(payor_id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_payouts_for_payor" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        ...
        if self.api_client.client_side_validation and ('payor_id' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `payor_id` when calling `get_payouts_for_payor`")  # noqa: E501
    ...
    def get_payouts_for_payor_v4(self, payor_id, **kwargs):  # noqa: E501
        """Get Payouts for Payor  # noqa: E501

        Get List of payouts for payor   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_payouts_for_payor_v4(payor_id, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.get_payouts_for_payor_v4_with_http_info(payor_id, **kwargs)  # noqa: E501

    def get_payouts_for_payor_v4_with_http_info(self, payor_id, **kwargs):  # noqa: E501
        """Get Payouts for Payor  # noqa: E501

        Get List of payouts for payor   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_payouts_for_payor_v4_with_http_info(payor_id, async_req=True)
        >>> result = thread.get()
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(GetPayoutsResponseV4, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        if self.api_client.client_side_validation and ('payor_id' not in local_var_params or  # noqa: E501
                                                        local_var_params['payor_id'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `payor_id` when calling `get_payouts_for_payor_v4`")  # noqa: E501
    ...
    def list_payments_audit_with_http_info(self, **kwargs):  # noqa: E501
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(ListPaymentsResponse, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
