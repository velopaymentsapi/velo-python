...
class UsersApi(object):
    ...
    def delete_user_by_id_v2(self, user_id, **kwargs):  # noqa: E501
        ...
        :param user_id: The UUID of the User. (required)
        :type user_id: str
    ...
    def invite_user(self, invite_user_request, **kwargs):  # noqa: E501
        ...
        :param invite_user_request: Details of User to invite (required)
    ...
    def list_users_with_http_info(self, **kwargs):  # noqa: E501
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(PagedUserResponse, status_code(int), headers(HTTPHeaderDict))
        """
    ...
    def register_sms(self, register_sms_request, **kwargs):  # noqa: E501
        ...
        :param register_sms_request: a SMS Number to send an OTP to (required)
        :type register_sms_request: RegisterSmsRequest
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
    ...
    def resend_token(self, user_id, resend_token_request, **kwargs):  # noqa: E501
        ...
        :param user_id: The UUID of the User. (required)
        :type user_id: str
        :param resend_token_request: The type of token to resend (required)
        :type resend_token_request: ResendTokenRequest
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
    ...
    def role_update(self, user_id, role_update_request, **kwargs):  # noqa: E501
        ...
        :param user_id: The UUID of the User. (required)
        :type user_id: str
        :param role_update_request: The Role to change to (required)
    ...
    def unregister_mfa(self, user_id, unregister_mfa_request, **kwargs):  # noqa: E501
        ...
        :param user_id: The UUID of the User. (required)
        :type user_id: str
        :param unregister_mfa_request: The MFA Type to unregister (required)
        :type unregister_mfa_request: UnregisterMFARequest
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
    ...
    def unregister_mfa_for_self(self, self_mfa_type_unregister_request, **kwargs):  # noqa: E501
        ...
        :param self_mfa_type_unregister_request: The MFA Type to unregister (required)
        :type self_mfa_type_unregister_request: SelfMFATypeUnregisterRequest
    ...
    def update_password_self(self, self_update_password_request, **kwargs):  # noqa: E501
        ...
        :param self_update_password_request: The password (required)
        :type self_update_password_request: SelfUpdatePasswordRequest
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
    ...
    def user_details_update(self, user_id, user_details_update_request, **kwargs):  # noqa: E501
        ...
        :param user_id: The UUID of the User. (required)
        :type user_id: str
        :param user_details_update_request: The details of the user to update (required)
    ...
    def user_details_update_for_self(self, payee_user_self_update_request, **kwargs):  # noqa: E501
        ...
        :param payee_user_self_update_request: The details of the user to update (required)
        :type payee_user_self_update_request: PayeeUserSelfUpdateRequest
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
    ...
    def user_details_update_for_self_with_http_info(self, payee_user_self_update_request, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('payee_user_self_update_request' not in local_var_params or  # noqa: E501
                                                        local_var_params['payee_user_self_update_request'] is None):  # noqa: E501
    ...
    def validate_password_self(self, password_request, **kwargs):  # noqa: E501
        ...
        :param password_request: The password (required)
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: ValidatePasswordResponse
        """
        kwargs['_return_http_data_only'] = True
    ...
    def validate_password_self_with_http_info(self, password_request, **kwargs):  # noqa: E501
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(ValidatePasswordResponse, status_code(int), headers(HTTPHeaderDict))
        """
