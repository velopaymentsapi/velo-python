...
class SourceAccountsApi(object):
    ...
    def get_source_accounts_v3(self, **kwargs):  # noqa: E501
        ...
        :param str type: The type of source account.
        :param int page: Page number. Default is 1.
        :param int page_size: The number of results to return in a page
        :param str sort: List of sort fields e.g. ?sort=name:asc Default is name:asc The supported sort fields are - fundingRef, name, balance 
        :param _preload_content: if False, the urllib3.HTTPResponse object will
    ...
    def set_notifications_request(self, source_account_id, set_notifications_request, **kwargs):  # noqa: E501
        ...
        <p>Set notifications for a given source account</p> <p>deprecated since 2.34 (use v3 version)</p>   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def set_notifications_request_v3(self, source_account_id, set_notifications_request2, **kwargs):  # noqa: E501
        """Set notifications  # noqa: E501

        <p>Set notifications for a given source account</p> <p>If the balance falls below the amount set in the request an email notification will be sent to the email address registered in the payor profile</p>   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.set_notifications_request_v3(source_account_id, set_notifications_request2, async_req=True)
        >>> result = thread.get()

        :param async_req bool: execute request asynchronously
        :param str source_account_id: Source account id (required)
        :param SetNotificationsRequest2 set_notifications_request2: Body to included minimum balance to set (required)
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.set_notifications_request_v3_with_http_info(source_account_id, set_notifications_request2, **kwargs)  # noqa: E501

    def set_notifications_request_v3_with_http_info(self, source_account_id, set_notifications_request2, **kwargs):  # noqa: E501
        """Set notifications  # noqa: E501

        <p>Set notifications for a given source account</p> <p>If the balance falls below the amount set in the request an email notification will be sent to the email address registered in the payor profile</p>   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.set_notifications_request_v3_with_http_info(source_account_id, set_notifications_request2, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['source_account_id', 'set_notifications_request2']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method set_notifications_request_v3" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'source_account_id' is set
        if ('source_account_id' not in local_var_params or
                local_var_params['source_account_id'] is None):
            raise ApiValueError("Missing the required parameter `source_account_id` when calling `set_notifications_request_v3`")  # noqa: E501
        # verify the required parameter 'set_notifications_request2' is set
        if ('set_notifications_request2' not in local_var_params or
                local_var_params['set_notifications_request2'] is None):
            raise ApiValueError("Missing the required parameter `set_notifications_request2` when calling `set_notifications_request_v3`")  # noqa: E501
        ...
        body_params = None
        if 'set_notifications_request2' in local_var_params:
            body_params = local_var_params['set_notifications_request2']
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.select_header_accept(
            ['application/json'])  # noqa: E501
    ...
    def transfer_funds_v2(self, source_account_id, transfer_request_v2, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.transfer_funds_v2(source_account_id, transfer_request_v2, async_req=True)
        >>> result = thread.get()

        :param async_req bool: execute request asynchronously
        :param str source_account_id: The 'from' source account id, which will be debited (required)
        :param TransferRequestV2 transfer_request_v2: Body (required)
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.transfer_funds_v2_with_http_info(source_account_id, transfer_request_v2, **kwargs)  # noqa: E501

    def transfer_funds_v2_with_http_info(self, source_account_id, transfer_request_v2, **kwargs):  # noqa: E501
        """Transfer Funds between source accounts  # noqa: E501

        Transfer funds between source accounts for a Payor. The 'from' source account is identified in the URL, and is the account which will be debited. The 'to' (destination) source account is in the body, and is the account which will be credited. Both source accounts must belong to the same Payor. There must be sufficient balance in the 'from' source account, otherwise the transfer attempt will fail.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.transfer_funds_v2_with_http_info(source_account_id, transfer_request_v2, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['source_account_id', 'transfer_request_v2']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method transfer_funds_v2" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'source_account_id' is set
        if ('source_account_id' not in local_var_params or
                local_var_params['source_account_id'] is None):
            raise ApiValueError("Missing the required parameter `source_account_id` when calling `transfer_funds_v2`")  # noqa: E501
        # verify the required parameter 'transfer_request_v2' is set
        if ('transfer_request_v2' not in local_var_params or
                local_var_params['transfer_request_v2'] is None):
            raise ApiValueError("Missing the required parameter `transfer_request_v2` when calling `transfer_funds_v2`")  # noqa: E501
        ...
        body_params = None
        if 'transfer_request_v2' in local_var_params:
            body_params = local_var_params['transfer_request_v2']
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.select_header_accept(
            ['application/json'])  # noqa: E501
    ...
    def transfer_funds_v3(self, source_account_id, transfer_request_v3, **kwargs):  # noqa: E501
        """Transfer Funds between source accounts  # noqa: E501

        Transfer funds between source accounts for a Payor. The 'from' source account is identified in the URL, and is the account which will be debited. The 'to' (destination) source account is in the body, and is the account which will be credited. Both source accounts must belong to the same Payor. There must be sufficient balance in the 'from' source account, otherwise the transfer attempt will fail.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.transfer_funds_v3(source_account_id, transfer_request_v3, async_req=True)
        >>> result = thread.get()

        :param async_req bool: execute request asynchronously
        :param str source_account_id: The 'from' source account id, which will be debited (required)
        :param TransferRequestV3 transfer_request_v3: Body (required)
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.transfer_funds_v3_with_http_info(source_account_id, transfer_request_v3, **kwargs)  # noqa: E501

    def transfer_funds_v3_with_http_info(self, source_account_id, transfer_request_v3, **kwargs):  # noqa: E501
        """Transfer Funds between source accounts  # noqa: E501

        Transfer funds between source accounts for a Payor. The 'from' source account is identified in the URL, and is the account which will be debited. The 'to' (destination) source account is in the body, and is the account which will be credited. Both source accounts must belong to the same Payor. There must be sufficient balance in the 'from' source account, otherwise the transfer attempt will fail.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.transfer_funds_v3_with_http_info(source_account_id, transfer_request_v3, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['source_account_id', 'transfer_request_v3']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if ('transfer_request_v3' not in local_var_params or
                local_var_params['transfer_request_v3'] is None):
            raise ApiValueError("Missing the required parameter `transfer_request_v3` when calling `transfer_funds_v3`")  # noqa: E501
        ...
        body_params = None
        if 'transfer_request_v3' in local_var_params:
            body_params = local_var_params['transfer_request_v3']
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.select_header_accept(
            ['application/json'])  # noqa: E501
