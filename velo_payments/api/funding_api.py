...
class FundingApi(object):
    ...
    def create_funding_request_v2(self, source_account_id, funding_request_v2, **kwargs):  # noqa: E501
        ...
        >>> thread = api.create_funding_request_v2(source_account_id, funding_request_v2, async_req=True)
        >>> result = thread.get()
        ...
        return self.create_funding_request_v2_with_http_info(source_account_id, funding_request_v2, **kwargs)  # noqa: E501

    def create_funding_request_v2_with_http_info(self, source_account_id, funding_request_v2, **kwargs):  # noqa: E501
        """Create Funding Request  # noqa: E501

        Instruct a funding request to transfer funds from the payor’s funding bank to the payor’s balance held within Velo  (202 - accepted, 400 - invalid request body, 404 - source account not found).  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_funding_request_v2_with_http_info(source_account_id, funding_request_v2, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    ...
                    " to method create_funding_request_v2" % key
                )
        ...
        if ('source_account_id' not in local_var_params or
            ...
            raise ApiValueError("Missing the required parameter `source_account_id` when calling `create_funding_request_v2`")  # noqa: E501
        ...
        if ('funding_request_v2' not in local_var_params or
            ...
            raise ApiValueError("Missing the required parameter `funding_request_v2` when calling `create_funding_request_v2`")  # noqa: E501
    ...
    def create_funding_request_v3(self, source_account_id, funding_request_v3, **kwargs):  # noqa: E501
        ...
        <p>Instruct a funding request to transfer funds from the payor’s funding bank to the payor’s balance held within Velo</p>   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def get_funding_account_v2_with_http_info(self, funding_account_id, **kwargs):  # noqa: E501
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(FundingAccountResponseV2, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='FundingAccountResponseV2',  # noqa: E501
            auth_settings=auth_settings,
            async_req=local_var_params.get('async_req'),
            _return_http_data_only=local_var_params.get('_return_http_data_only'),  # noqa: E501
            _preload_content=local_var_params.get('_preload_content', True),
    ...
    def get_funding_accounts_v2(self, **kwargs):  # noqa: E501
        ...
        :param str country_code: The 2 letter ISO 3166-1 country code (upper case)
        :param str currency: The ISO 4217 currency code
        :param str type: The type of funding account.
    ...
    def get_funding_accounts_v2_with_http_info(self, **kwargs):  # noqa: E501
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(ListFundingAccountsResponseV2, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        all_params = ['payor_id', 'name', 'country_code', 'currency', 'type', 'page', 'page_size', 'sort', 'sensitive']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if 'country_code' in local_var_params:
            query_params.append(('countryCode', local_var_params['country_code']))  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='ListFundingAccountsResponseV2',  # noqa: E501
            auth_settings=auth_settings,
            async_req=local_var_params.get('async_req'),
            _return_http_data_only=local_var_params.get('_return_http_data_only'),  # noqa: E501
            _preload_content=local_var_params.get('_preload_content', True),
    ...
    def get_funding_by_id_v1(self, funding_id, **kwargs):  # noqa: E501
        """Get Funding  # noqa: E501

        Get Funding by Id  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_funding_by_id_v1(funding_id, async_req=True)
        >>> result = thread.get()

        :param async_req bool: execute request asynchronously
        :param str funding_id: (required)
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.get_funding_by_id_v1_with_http_info(funding_id, **kwargs)  # noqa: E501

    def get_funding_by_id_v1_with_http_info(self, funding_id, **kwargs):  # noqa: E501
        """Get Funding  # noqa: E501

        Get Funding by Id  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_funding_by_id_v1_with_http_info(funding_id, async_req=True)
        >>> result = thread.get()
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(FundingResponse, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_funding_by_id_v1" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'funding_id' is set
        if ('funding_id' not in local_var_params or
                local_var_params['funding_id'] is None):
            raise ApiValueError("Missing the required parameter `funding_id` when calling `get_funding_by_id_v1`")  # noqa: E501

        collection_formats = {}

        path_params = {}
        if 'funding_id' in local_var_params:
            path_params['fundingId'] = local_var_params['funding_id']  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='FundingResponse',  # noqa: E501
            auth_settings=auth_settings,
            async_req=local_var_params.get('async_req'),
            _return_http_data_only=local_var_params.get('_return_http_data_only'),  # noqa: E501
            _preload_content=local_var_params.get('_preload_content', True),
