...
class PayorsApi(object):
    ...
    def get_payor_by_id(self, payor_id, **kwargs):  # noqa: E501
        ...
        :param payor_id: The Payor Id (required)
        :type payor_id: str
    ...
    def get_payor_by_id_with_http_info(self, payor_id, **kwargs):  # noqa: E501
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(PayorV1, status_code(int), headers(HTTPHeaderDict))
        """
    ...
    def get_payor_by_id_v2_with_http_info(self, payor_id, **kwargs):  # noqa: E501
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(PayorV2, status_code(int), headers(HTTPHeaderDict))
        """
    ...
    def payor_create_api_key_request(self, payor_id, application_id, payor_create_api_key_request, **kwargs):  # noqa: E501
        ...
        :param payor_create_api_key_request: Details of application API key to create (required)
        :type payor_create_api_key_request: PayorCreateApiKeyRequest
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: PayorCreateApiKeyResponse
        """
        kwargs['_return_http_data_only'] = True
    ...
    def payor_create_api_key_request_with_http_info(self, payor_id, application_id, payor_create_api_key_request, **kwargs):  # noqa: E501
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(PayorCreateApiKeyResponse, status_code(int), headers(HTTPHeaderDict))
        """
    ...
    def payor_create_application_request(self, payor_id, payor_create_application_request, **kwargs):  # noqa: E501
        ...
        :param payor_id: The Payor Id (required)
        :type payor_id: str
        :param payor_create_application_request: Details of application to create (required)
        :type payor_create_application_request: PayorCreateApplicationRequest
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
    ...
    def payor_email_opt_out(self, payor_id, payor_email_opt_out_request, **kwargs):  # noqa: E501
        ...
        :param payor_id: The Payor Id (required)
        :type payor_id: str
        :param payor_email_opt_out_request: Reminder Emails Opt-Out Request (required)
        :type payor_email_opt_out_request: PayorEmailOptOutRequest
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
    ...
    def payor_get_branding_with_http_info(self, payor_id, **kwargs):  # noqa: E501
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(PayorBrandingResponse, status_code(int), headers(HTTPHeaderDict))
        """
    ...
    def payor_links_with_http_info(self, **kwargs):  # noqa: E501
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(PayorLinksResponse, status_code(int), headers(HTTPHeaderDict))
        """
