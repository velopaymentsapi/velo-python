...
class PayorsApi(object):
    ...
    def payor_links(self, descendants_of_payor, **kwargs):  # noqa: E501
        """List Payor Links  # noqa: E501

        This endpoint allows you to list payor links  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.payor_links(descendants_of_payor, async_req=True)
        >>> result = thread.get()

        :param async_req bool: execute request asynchronously
        :param str descendants_of_payor: The Payor ID from which to start the query to show all descendants (required)
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.payor_links_with_http_info(descendants_of_payor, **kwargs)  # noqa: E501

    def payor_links_with_http_info(self, descendants_of_payor, **kwargs):  # noqa: E501
        """List Payor Links  # noqa: E501

        This endpoint allows you to list payor links  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.payor_links_with_http_info(descendants_of_payor, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['descendants_of_payor', 'fields']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if ('descendants_of_payor' not in local_var_params or
                local_var_params['descendants_of_payor'] is None):
            raise ApiValueError("Missing the required parameter `descendants_of_payor` when calling `payor_links`")  # noqa: E501
