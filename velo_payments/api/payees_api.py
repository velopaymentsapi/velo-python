...
class PayeesApi(object):
    ...
    def delete_payee_by_id_v1(self, payee_id, **kwargs):  # noqa: E501
        ...
        :param payee_id: The UUID of the payee. (required)
        :type payee_id: str
    ...
    def get_payee_by_id_v1_with_http_info(self, payee_id, **kwargs):  # noqa: E501
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(Payee, status_code(int), headers(HTTPHeaderDict))
        """
    ...
    def get_payee_by_id_v2_with_http_info(self, payee_id, **kwargs):  # noqa: E501
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(PayeeResponseV2, status_code(int), headers(HTTPHeaderDict))
        """
    ...
    def get_payee_by_id_v3_with_http_info(self, payee_id, **kwargs):  # noqa: E501
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(PayeeDetailResponse, status_code(int), headers(HTTPHeaderDict))
        """
    ...
    def get_payee_by_id_v4_with_http_info(self, payee_id, **kwargs):  # noqa: E501
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(PayeeDetailResponse2, status_code(int), headers(HTTPHeaderDict))
        """
    ...
    def list_payee_changes(self, payor_id, updated_since, **kwargs):  # noqa: E501
        ...
        :param payor_id: The Payor ID to find associated Payees (required)
        :type payor_id: str
        :param updated_since: The updatedSince filter in the format YYYY-MM-DDThh:mm:ss+hh:mm (required)
    ...
    def list_payee_changes_with_http_info(self, payor_id, updated_since, **kwargs):  # noqa: E501
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(PayeeDeltaResponse, status_code(int), headers(HTTPHeaderDict))
        """
    ...
    def list_payee_changes_v3_with_http_info(self, payor_id, updated_since, **kwargs):  # noqa: E501
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(PayeeDeltaResponse2, status_code(int), headers(HTTPHeaderDict))
        """
    ...
    def list_payees_v1(self, payor_id, **kwargs):  # noqa: E501
        ...
        :param payor_id: The account owner Payor ID (required)
        :type payor_id: str
        :param ofac_status: The ofacStatus of the payees.
        :type ofac_status: OfacStatus
        :param onboarded_status: The onboarded status of the payees.
        :type onboarded_status: OnboardedStatus
    ...
    def list_payees_v1_with_http_info(self, payor_id, **kwargs):  # noqa: E501
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(PagedPayeeResponse, status_code(int), headers(HTTPHeaderDict))
        """
    ...
    def list_payees_v3_with_http_info(self, payor_id, **kwargs):  # noqa: E501
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(PagedPayeeResponse2, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        if 'payor_id' in local_var_params and local_var_params['payor_id'] is not None:  # noqa: E501
            query_params.append(('payorId', local_var_params['payor_id']))  # noqa: E501
        if 'watchlist_status' in local_var_params and local_var_params['watchlist_status'] is not None:  # noqa: E501
    ...
    def payee_details_update_v3(self, payee_id, update_payee_details_request, **kwargs):  # noqa: E501
        ...
        :param payee_id: The UUID of the payee. (required)
        :type payee_id: str
        :param update_payee_details_request: Request to update payee details (required)
        :type update_payee_details_request: UpdatePayeeDetailsRequest
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
    ...
    def payee_details_update_v3_with_http_info(self, payee_id, update_payee_details_request, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('update_payee_details_request' not in local_var_params or  # noqa: E501
                                                        local_var_params['update_payee_details_request'] is None):  # noqa: E501
    ...
    def payee_details_update_v4(self, payee_id, update_payee_details_request2, **kwargs):  # noqa: E501
        ...
        :param payee_id: The UUID of the payee. (required)
        :type payee_id: str
        :param update_payee_details_request2: Request to update payee details (required)
        :type update_payee_details_request2: UpdatePayeeDetailsRequest2
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
    ...
    def payee_details_update_v4_with_http_info(self, payee_id, update_payee_details_request2, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('update_payee_details_request2' not in local_var_params or  # noqa: E501
                                                        local_var_params['update_payee_details_request2'] is None):  # noqa: E501
    ...
    def v1_payees_payee_id_remote_id_update_post(self, payee_id, update_remote_id_request, **kwargs):  # noqa: E501
        ...
        :param payee_id: The UUID of the payee. (required)
        :type payee_id: str
        :param update_remote_id_request: Request to update payee remote id v1 (required)
        :type update_remote_id_request: UpdateRemoteIdRequest
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
    ...
    def v3_payees_payee_id_remote_id_update_post(self, payee_id, update_remote_id_request, **kwargs):  # noqa: E501
        ...
        :param payee_id: The UUID of the payee. (required)
        :type payee_id: str
        :param update_remote_id_request: Request to update payee remote id v3 (required)
        :type update_remote_id_request: UpdateRemoteIdRequest
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _preload_content: if False, the urllib3.HTTPResponse object will
    ...
    def v4_payees_payee_id_remote_id_update_post(self, payee_id, update_remote_id_request, **kwargs):  # noqa: E501
        """Update Payee Remote Id  # noqa: E501
        ...
        >>> thread = api.v4_payees_payee_id_remote_id_update_post(payee_id, update_remote_id_request, async_req=True)
        >>> result = thread.get()

        :param payee_id: The UUID of the payee. (required)
        :type payee_id: str
        :param update_remote_id_request: Request to update payee remote id v4 (required)
        :type update_remote_id_request: UpdateRemoteIdRequest
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _preload_content: if False, the urllib3.HTTPResponse object will
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.v4_payees_payee_id_remote_id_update_post_with_http_info(payee_id, update_remote_id_request, **kwargs)  # noqa: E501

    def v4_payees_payee_id_remote_id_update_post_with_http_info(self, payee_id, update_remote_id_request, **kwargs):  # noqa: E501
        """Update Payee Remote Id  # noqa: E501
        ...
        >>> thread = api.v4_payees_payee_id_remote_id_update_post_with_http_info(payee_id, update_remote_id_request, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('update_remote_id_request' not in local_var_params or  # noqa: E501
                                                        local_var_params['update_remote_id_request'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `update_remote_id_request` when calling `v4_payees_payee_id_remote_id_update_post`")  # noqa: E501
