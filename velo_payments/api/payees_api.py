...
class PayeesApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_payee_by_id_v3_endpoint = _Endpoint(
            settings={
                'response_type': (PayeeDetailResponseV3,),
                'auth': [
                    'OAuth2'
                ],
                'endpoint_path': '/v3/payees/{payeeId}',
        ...
        self.get_payee_by_id_v4_endpoint = _Endpoint(
            settings={
                'response_type': (PayeeDetailResponseV4,),
                'auth': [
                    'OAuth2'
                ],
                'endpoint_path': '/v4/payees/{payeeId}',
        ...
        self.list_payee_changes_v3_endpoint = _Endpoint(
            settings={
                'response_type': (PayeeDeltaResponseV3,),
                'auth': [
                    'OAuth2'
                ],
        ...
        self.list_payee_changes_v4_endpoint = _Endpoint(
            settings={
                'response_type': (PayeeDeltaResponseV4,),
                'auth': [
                    'OAuth2'
                ],
        ...
        self.list_payees_v3_endpoint = _Endpoint(
            settings={
                'response_type': (PagedPayeeResponseV3,),
                'auth': [
                    'OAuth2'
                ],
        ...
        self.list_payees_v4_endpoint = _Endpoint(
            settings={
                'response_type': (PagedPayeeResponseV4,),
                'auth': [
                    'OAuth2'
                ],
        ...
        self.payee_details_update_v3_endpoint = _Endpoint(
            ...
            params_map={
                'all': [
                    'payee_id',
                    'update_payee_details_request_v3',
                ],
                'required': [
                    'payee_id',
                    'update_payee_details_request_v3',
            ...
            root_map={
                ...
                'location_map': {
                    'payee_id': 'path',
                    'update_payee_details_request_v3': 'body',
                },
                'collection_format_map': {
                }
            },
        ...
        self.payee_details_update_v4_endpoint = _Endpoint(
            ...
            params_map={
                'all': [
                    'payee_id',
                    'update_payee_details_request_v4',
                ],
                'required': [
                    'payee_id',
                    'update_payee_details_request_v4',
            ...
            root_map={
                ...
                'location_map': {
                    'payee_id': 'path',
                    'update_payee_details_request_v4': 'body',
                },
                'collection_format_map': {
                }
            },
        ...
        self.v3_payees_payee_id_remote_id_update_post_endpoint = _Endpoint(
            ...
            root_map={
                ...
                'location_map': {
                    'payee_id': 'path',
                    'update_remote_id_request_v3': 'body',
                },
                'collection_format_map': {
                }
            },
        ...
        self.v4_payees_payee_id_remote_id_update_post_endpoint = _Endpoint(
            ...
            root_map={
                ...
                'location_map': {
                    'payee_id': 'path',
                    'update_remote_id_request_v4': 'body',
                },
                'collection_format_map': {
                }
            },
    ...
    def payee_details_update_v3(
        ...
        **kwargs
        ...
        Args:
            payee_id (str): The UUID of the payee.
            update_payee_details_request_v3 (UpdatePayeeDetailsRequestV3): Request to update payee details
        ...
        kwargs['payee_id'] = \
            payee_id
        kwargs['update_payee_details_request_v3'] = \
            update_payee_details_request_v3
    ...
    def payee_details_update_v4(
        ...
        **kwargs
        ...
        Args:
            payee_id (str): The UUID of the payee.
            update_payee_details_request_v4 (UpdatePayeeDetailsRequestV4): Request to update payee details
        ...
        kwargs['payee_id'] = \
            payee_id
        kwargs['update_payee_details_request_v4'] = \
            update_payee_details_request_v4
    ...
    def v3_payees_payee_id_remote_id_update_post(
        ...
        **kwargs
        ...
        Args:
            payee_id (str): The UUID of the payee.
            update_remote_id_request_v3 (UpdateRemoteIdRequestV3): Request to update payee remote id v3
        ...
        kwargs['payee_id'] = \
            payee_id
        kwargs['update_remote_id_request_v3'] = \
            update_remote_id_request_v3
    ...
    def v4_payees_payee_id_remote_id_update_post(
        ...
        **kwargs
        ...
        Args:
            payee_id (str): The UUID of the payee.
            update_remote_id_request_v4 (UpdateRemoteIdRequestV4): Request to update payee remote id v4
        ...
        kwargs['payee_id'] = \
            payee_id
        kwargs['update_remote_id_request_v4'] = \
            update_remote_id_request_v4
