...
class PayoutHistoryApi(object):
    ...
    def get_payout_stats(self, **kwargs):  # noqa: E501
        """Get Payout Statistics  # noqa: E501

        Get payout statistics for a payor.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_payout_stats(async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.get_payout_stats_with_http_info(**kwargs)  # noqa: E501

    def get_payout_stats_with_http_info(self, **kwargs):  # noqa: E501
        """Get Payout Statistics  # noqa: E501

        Get payout statistics for a payor.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_payout_stats_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_payout_stats" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
