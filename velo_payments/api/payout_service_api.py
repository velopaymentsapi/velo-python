...
class PayoutServiceApi(object):
    ...
    def create_quote_for_payout_v3(self, payout_id, **kwargs):  # noqa: E501
        ...
        :param payout_id: Id of the payout (required)
        :type payout_id: str
    ...
    def create_quote_for_payout_v3_with_http_info(self, payout_id, **kwargs):  # noqa: E501
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(QuoteResponseV3, status_code(int), headers(HTTPHeaderDict))
        """
    ...
    def get_payments_for_payout_v3_with_http_info(self, payout_id, **kwargs):  # noqa: E501
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(PagedPaymentsResponseV3, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        if 'payor_payment_id' in local_var_params and local_var_params['payor_payment_id'] is not None:  # noqa: E501
    ...
    def get_payout_summary_v3_with_http_info(self, payout_id, **kwargs):  # noqa: E501
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(PayoutSummaryResponseV3, status_code(int), headers(HTTPHeaderDict))
        """
    ...
    def submit_payout_v3(self, create_payout_request_v3, **kwargs):  # noqa: E501
        ...
        :param create_payout_request_v3: Post amount to transfer using stored funding account details. (required)
        :type create_payout_request_v3: CreatePayoutRequestV3
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
    ...
    def submit_payout_v3_with_http_info(self, create_payout_request_v3, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('create_payout_request_v3' not in local_var_params or  # noqa: E501
                                                        local_var_params['create_payout_request_v3'] is None):  # noqa: E501
    ...
    def withdraw_payment(self, payment_id, withdraw_payment_request, **kwargs):  # noqa: E501
        ...
        :param payment_id: Id of the Payment (required)
        :type payment_id: str
        :param withdraw_payment_request: details for withdrawal (required)
        :type withdraw_payment_request: WithdrawPaymentRequest
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
    ...
    def withdraw_payment_with_http_info(self, payment_id, withdraw_payment_request, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('withdraw_payment_request' not in local_var_params or  # noqa: E501
                                                        local_var_params['withdraw_payment_request'] is None):  # noqa: E501
    ...
    def withdraw_payout_v3(self, payout_id, **kwargs):  # noqa: E501
        ...
        Withdraw Payout will delete payout details from payout service and rails services but will just move the status of the payout to WITHDRAWN in payment audit.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
