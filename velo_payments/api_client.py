...
from velo_payments.exceptions import ApiTypeError, ApiValueError, ApiException
from velo_payments.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = 'OpenAPI-Generator/2.30.53-beta.1/python'
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance.list_payment_channel_rules_v1  # this is an instance of the class Endpoint
        api_instance.list_payment_channel_rules_v1()  # this invokes api_instance.list_payment_channel_rules_v1.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.list_payment_channel_rules_v1.callable or self.callable in this class
