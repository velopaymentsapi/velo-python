...
class CreatePayeesCSVRequest(object):
    ...
    def address_country(self, address_country):
        ...
        if address_country is not None and len(address_country) > 50:
    ...
    def company_ein(self, company_ein):
        ...
        :type: str
        """
        if company_ein is not None and not re.search(r'[\\d]{9}', company_ein):  # noqa: E501
    ...
    def payment_channel_country_code(self, payment_channel_country_code):
        ...
        if payment_channel_country_code not in allowed_values:
            raise ValueError(
    ...
    def payment_channel_currency(self, payment_channel_currency):
        ...
        if payment_channel_currency not in allowed_values:
            raise ValueError(
    ...
    def payee_language(self, payee_language):
        ...
        if payee_language not in allowed_values:
            raise ValueError(
