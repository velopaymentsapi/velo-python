...
class GetPaymentsForPayoutResponseV4Summary(object):
    ...
    def __init__(self, payout_status=None, submitted_date_time=None, instructed_date_time=None, payout_memo=None, total_payments=None, confirmed_payments=None, released_payments=None, incomplete_payments=None, returned_payments=None, local_vars_configuration=None):  # noqa: E501
