...
class SourceAccountResponseV2(object):
    ...
    def funding_ref(self, funding_ref):
        ...
        :type: str
        """
        if self.local_vars_configuration.client_side_validation and funding_ref is None:  # noqa: E501
    ...
    def physical_account_name(self, physical_account_name):
        ...
        :type: str
        """
        if self.local_vars_configuration.client_side_validation and physical_account_name is None:  # noqa: E501
    ...
    def pooled(self, pooled):
        ...
        :type: bool
        """
        if self.local_vars_configuration.client_side_validation and pooled is None:  # noqa: E501
    ...
    def balance_visible(self, balance_visible):
        ...
        :type: bool
        """
        if self.local_vars_configuration.client_side_validation and balance_visible is None:  # noqa: E501
    ...
    def auto_top_up_config(self, auto_top_up_config):
        ...
        """
        if self.local_vars_configuration.client_side_validation and auto_top_up_config is None:  # noqa: E501
            raise ValueError("Invalid value for `auto_top_up_config`, must not be `None`")  # noqa: E501
