...
class PaymentInstructionV3(object):
    ...
    def __init__(self, remote_id=None, currency=None, amount=None, payment_memo=None, source_account_name=None, payor_payment_id=None, transmission_type=None, local_vars_configuration=None):  # noqa: E501
