...
class PaymentInstructionV3(object):
    ...
    def __init__(self, remote_id=None, currency=None, amount=None, payment_memo=None, source_account_name=None, payor_payment_id=None, transmission_type=None, remote_system_id=None, payment_metadata=None):  # noqa: E501
    ...
    def source_account_name(self):
        ...
        Must match a valid source account name belonging to the payor  # noqa: E501
    ...
    def transmission_type(self):
        ...
        Optionally choose a specific transmission method for the payment  # noqa: E501
    ...
    def transmission_type(self, transmission_type):
        ...
        if transmission_type not in allowed_values:
            raise ValueError(
                "Invalid value for `transmission_type` ({0}), must be one of {1}"  # noqa: E501
