...
class UserResponse(object):
    ...
    def __init__(self, id=None, status=None, email=None, sms_number=None, primary_contact_number=None, secondary_contact_number=None, first_name=None, last_name=None, entity_id=None, roles=None, mfa_type=None, mfa_status=None, locked_out=None, locked_out_timestamp=None, local_vars_configuration=None):  # noqa: E501
