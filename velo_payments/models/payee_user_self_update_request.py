...
class PayeeUserSelfUpdateRequest(object):
    ...
    def __init__(self, primary_contact_number=None, secondary_contact_number=None, first_name=None, last_name=None, email=None, sms_number=None, local_vars_configuration=None):  # noqa: E501
