...
class PayorV2(object):
    ...
    def __init__(self, payor_id=None, payor_name=None, payor_xid=None, address=None, primary_contact_name=None, primary_contact_phone=None, primary_contact_email=None, kyc_state=None, manual_lockout=None, payee_grace_period_processing_enabled=None, payee_grace_period_days=None, collective_alias=None, support_contact=None, dba_name=None, allows_language_choice=None, reminder_emails_opt_out=None, language=None, includes_reports=None, wu_customer_id=None, max_master_payor_admins=None, payment_rails=None, transmission_types=None, local_vars_configuration=None):  # noqa: E501
    ...
    def payment_rails(self, payment_rails):
        ...
        :type payment_rails: PaymentRails
        """
