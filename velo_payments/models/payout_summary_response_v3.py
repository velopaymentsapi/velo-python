...
class PayoutSummaryResponseV3(object):
    ...
    def __init__(self, payout_id=None, status=None, payments_submitted=None, payments_accepted=None, payments_rejected=None, payments_withdrawn=None, fx_summaries=None, accounts=None, accepted_payments=None, rejected_payments=None):  # noqa: E501
