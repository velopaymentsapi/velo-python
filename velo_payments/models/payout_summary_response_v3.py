...
class PayoutSummaryResponseV3(object):
    ...
    def __init__(self, payout_id=None, status=None, payments_submitted=None, payments_accepted=None, payments_rejected=None, payments_withdrawn=None, fx_summaries=None, accounts=None, accepted_payments=None, rejected_payments=None, local_vars_configuration=None):  # noqa: E501
    ...
    def payments_withdrawn(self, payments_withdrawn):
        ...
        """
        if self.local_vars_configuration.client_side_validation and payments_withdrawn is None:  # noqa: E501
