...
class PayoutSummaryAuditV3(object):
    ...
    def __init__(self, payout_id=None, payor_id=None, status=None, date_time=None, submitted_date_time=None, instructed_date_time=None, withdrawn_date_time=None, total_payments=None, total_incomplete_payments=None, total_failed_payments=None, source_account_summary=None, fx_summaries=None, payout_memo=None):  # noqa: E501
