...
class GetPaymentsForPayoutResponseV3Summary(object):
    ...
    def __init__(self, payout_status=None, submitted_date_time=None, instructed_date_time=None, payout_memo=None, total_payments=None, confirmed_payments=None, released_payments=None, incomplete_payments=None, failed_payments=None):  # noqa: E501
