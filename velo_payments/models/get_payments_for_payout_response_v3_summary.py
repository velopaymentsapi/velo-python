...
class GetPaymentsForPayoutResponseV3Summary(object):
    ...
    def payout_status(self):
        ...
        The current status of the payout. One of the following values: ACCEPTED, REJECTED, SUBMITTED, QUOTED, INSTRUCTED, COMPLETED, INCOMPLETE, CONFIRMED, WITHDRAWN  # noqa: E501
