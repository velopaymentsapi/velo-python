...
class PayorAddressV2(object):
    ...
    def __init__(self, line1=None, line2=None, line3=None, line4=None, city=None, county_or_province=None, zip_or_postcode=None, country=None):  # noqa: E501
        """PayorAddressV2 - a model defined in OpenAPI"""  # noqa: E501
        ...
        if line4 is not None:
            self.line4 = line4
        self.city = city
        if county_or_province is not None:
            self.county_or_province = county_or_province
        if zip_or_postcode is not None:
            self.zip_or_postcode = zip_or_postcode
        self.country = country

    @property
    def line1(self):
        """Gets the line1 of this PayorAddressV2.  # noqa: E501


        :return: The line1 of this PayorAddressV2.  # noqa: E501
        :rtype: str
        """
        return self._line1
    ...
    def line1(self, line1):
        ...
        :param line1: The line1 of this PayorAddressV2.  # noqa: E501
        :type: str
        """
        if line1 is None:
            raise ValueError("Invalid value for `line1`, must not be `None`")  # noqa: E501
        if line1 is not None and len(line1) > 255:
            raise ValueError("Invalid value for `line1`, length must be less than or equal to `255`")  # noqa: E501
        if line1 is not None and len(line1) < 2:
            raise ValueError("Invalid value for `line1`, length must be greater than or equal to `2`")  # noqa: E501

        self._line1 = line1

    @property
    def line2(self):
        """Gets the line2 of this PayorAddressV2.  # noqa: E501


        :return: The line2 of this PayorAddressV2.  # noqa: E501
        :rtype: str
        """
        return self._line2
    ...
    def line2(self, line2):
        ...
        :param line2: The line2 of this PayorAddressV2.  # noqa: E501
        :type: str
        """
        if line2 is not None and len(line2) > 255:
            raise ValueError("Invalid value for `line2`, length must be less than or equal to `255`")  # noqa: E501
    ...
    @property
    def line3(self):
        """Gets the line3 of this PayorAddressV2.  # noqa: E501


        :return: The line3 of this PayorAddressV2.  # noqa: E501
        :rtype: str
        """
        return self._line3
    ...
    def line3(self, line3):
        ...
        :param line3: The line3 of this PayorAddressV2.  # noqa: E501
        :type: str
        """
        if line3 is not None and len(line3) > 255:
            raise ValueError("Invalid value for `line3`, length must be less than or equal to `255`")  # noqa: E501
    ...
    @property
    def line4(self):
        """Gets the line4 of this PayorAddressV2.  # noqa: E501


        :return: The line4 of this PayorAddressV2.  # noqa: E501
        :rtype: str
        """
        return self._line4
    ...
    def line4(self, line4):
        ...
        :param line4: The line4 of this PayorAddressV2.  # noqa: E501
        :type: str
        """
        if line4 is not None and len(line4) > 255:
            raise ValueError("Invalid value for `line4`, length must be less than or equal to `255`")  # noqa: E501
    ...
    @property
    def city(self):
        """Gets the city of this PayorAddressV2.  # noqa: E501


        :return: The city of this PayorAddressV2.  # noqa: E501
        :rtype: str
        """
        return self._city
    ...
    def city(self, city):
        ...
        :param city: The city of this PayorAddressV2.  # noqa: E501
        :type: str
        """
        if city is None:
    ...
    def county_or_province(self):
        """Gets the county_or_province of this PayorAddressV2.  # noqa: E501


        :return: The county_or_province of this PayorAddressV2.  # noqa: E501
        :rtype: str
        """
    ...
    def county_or_province(self, county_or_province):
        ...
        :param county_or_province: The county_or_province of this PayorAddressV2.  # noqa: E501
        :type: str
        """
        if county_or_province is not None and len(county_or_province) > 100:
            raise ValueError("Invalid value for `county_or_province`, length must be less than or equal to `100`")  # noqa: E501
    ...
    def zip_or_postcode(self):
        """Gets the zip_or_postcode of this PayorAddressV2.  # noqa: E501


        :return: The zip_or_postcode of this PayorAddressV2.  # noqa: E501
        :rtype: str
        """
    ...
    def zip_or_postcode(self, zip_or_postcode):
        ...
        :param zip_or_postcode: The zip_or_postcode of this PayorAddressV2.  # noqa: E501
        :type: str
        """
        if zip_or_postcode is not None and len(zip_or_postcode) > 30:
            raise ValueError("Invalid value for `zip_or_postcode`, length must be less than or equal to `30`")  # noqa: E501
    ...
    @property
    def country(self):
        """Gets the country of this PayorAddressV2.  # noqa: E501


        :return: The country of this PayorAddressV2.  # noqa: E501
        :rtype: str
        """
    ...
    def country(self, country):
        ...
        :param country: The country of this PayorAddressV2.  # noqa: E501
        :type: str
        """
        if country is None:
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PayorAddressV2):
            return False
