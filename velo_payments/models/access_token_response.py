...
class AccessTokenResponse(object):
    ...
    def __init__(self, access_token=None, token_type='bearer', refresh_token=None, expires_in=None, scope=None, user_info=None, entity_ids=None, local_vars_configuration=None):  # noqa: E501
