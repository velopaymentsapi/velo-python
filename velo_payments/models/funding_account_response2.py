...
class FundingAccountResponse2(object):
    ...
    def __init__(self, id=None, payor_id=None, account_name=None, account_number=None, routing_number=None, name=None, currency=None, country=None, type=None, local_vars_configuration=None):  # noqa: E501
