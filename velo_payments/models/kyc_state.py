...
class KycState(object):
    ...
    allowable_values = [FAILED_KYC, PASSED_KYC, REQUIRES_KYC]  # noqa: E501
    ...
    def __init__(self, local_vars_configuration=None):  # noqa: E501
        """KycState - a model defined in OpenAPI"""  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, KycState):
            return False
