...
class InviteUserRequest(object):
    ...
    def __init__(self, email=None, mfa_type=None, sms_number=None, primary_contact_number=None, secondary_contact_number=None, roles=None, first_name=None, last_name=None, entity_id=None, verification_code=None):  # noqa: E501
