...
class FundingAudit(object):
    ...
    def __init__(self, amount=None, currency=None, date_time=None, status=None, source_account_name=None, funding_account_name=None, funding_type=None, events=None, topup_type=None, local_vars_configuration=None):  # noqa: E501
