...
class FundingAudit(object):
    ...
    def __init__(self, amount=None, date_time=None, status=None, currency=None, source_account_name=None, funding_account_name=None, funding_type=None, events=None, topup_type=None):  # noqa: E501
    ...
    def topup_type(self, topup_type):
        ...
        if topup_type not in allowed_values:
            raise ValueError(
