...
class TestPayeeInvitationApi(unittest.TestCase):
    ...
    def test_get_payees_invitation_status_v4(self):
    ...
    def test_query_batch_status_v3(self):
    ...
    def test_query_batch_status_v4(self):
    ...
    def test_resend_payee_invite_v1(self):
        """Test case for resend_payee_invite_v1

        Resend Payee Invite  # noqa: E501
        """
        pass

    def test_resend_payee_invite_v3(self):
    ...
    def test_resend_payee_invite_v4(self):
