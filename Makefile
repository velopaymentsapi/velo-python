...
info:
	...
	sed -i.bak "s/Payment cannot be processed because of the Payee's OFAC or Compliance Status/Payment cannot be processed because of the Payee OFAC or Compliance Status/" test/test_rejected_payment.py && rm test/test_rejected_payment.py.bak
	# adjust tox file
